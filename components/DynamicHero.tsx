...
const defaultSlides: HeroSlide[] = [
  {
    ...
    title: "Make Your Business Impossible to Overlook",
    subtitle: "Printing • Branding • Signage • Promotional Production",
    description:
      "From corporate branding and vehicle wraps to 3D signage, UV printing, and promotional products — Brandson Media turns business ideas into physical brand experiences.",
    cta: { text: "Start Your Project", href: "/contact", variant: "default" },
    badge: "Nairobi, Kenya",
    features: ["In-house Production", "Reliable Turnaround", "Local Support"],
  },
  {
    id: "2",
    type: "video",
    src: "/uv-printing.mp4",
    title: "UV Printing That Lasts",
    subtitle: "Promotional Products & Gifts",
    description:
      "Vibrant, scratch-resistant UV printing on bottles, notebooks, pens, and gifts — branding that stays sharp in the real world.",
    cta: { text: "Explore UV Printing", href: "/services/uv-printing", variant: "outline" },
    badge: "In-house",
    features: ["Vibrant Colour", "Water-resistant", "Small or Bulk Runs"],
  },
  {
    id: "3",
    type: "image",
    src: "/corporate-event-branding-kenya.jpg",
    title: "Event Branding That Photographs Well",
    subtitle: "Backdrops • Banners • Giveaways",
    description:
      "Complete event branding solutions — from stage backdrops to roll-up banners and branded giveaways that make your event look professional.",
    cta: { text: "View Our Work", href: "/portfolio", variant: "secondary" },
    features: ["Custom Designs", "Fast Turnaround", "On-site Friendly"],
  },
  {
    id: "4",
    type: "video",
