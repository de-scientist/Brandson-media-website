...
import { business, socials, serviceLinks } from "@/lib/site"
...
export function Footer() {
  const address = `${business.address.street}, ${business.address.city}, ${business.address.countryName}`
  return (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-sm text-dark-section-fg/80 leading-relaxed">
              Printing, branding, signage, and promotional production in Nairobi, Kenya — helping
              businesses become more visible, professional, and memorable.
            </p>
            ...
            <div className="flex flex-wrap items-center gap-3 pt-2">
              {socials.map((social) => (
                ...
                >
                  ...
                  {social.name === "YouTube" && (
                    <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true"><path fillRule="evenodd" d="M23.498 6.186a2.973 2.973 0 0 0-2.093-2.106C19.673 3.5 12 3.5 12 3.5s-7.673 0-9.405.58A2.973 2.973 0 0 0 .502 6.186 31.34 31.34 0 0 0 0 12a31.34 31.34 0 0 0 .502 5.814 2.973 2.973 0 0 0 2.093 2.106C4.327 20.5 12 20.5 12 20.5s7.673 0 9.405-.58a2.973 2.973 0 0 0 2.093-2.106A31.34 31.34 0 0 0 24 12a31.34 31.34 0 0 0-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z" clipRule="evenodd" /></svg>
                  )}
